...
(() => {
	...
	function t(t) {
		...
		for (let f = 0; f < t.length; f++) {
			...
			if (92 === h) u += t.slice(f, f + 2), f += 1;
			else if (47 === h && 42 === t.charCodeAt(f + 1)) {
				let e = f;
				...
				if (h === e) {
					...
					} else if (-1 === l && 58 === o) l = u.length + n - r;
					else {
						if (59 === o && 0 === e.length) {
							u += t.slice(r, n), f = n;
							break
				...
				} else if (59 === h && 64 === u.charCodeAt(0)) c = r(u), s ? s.nodes.push(c) : i.push(c), u = "", c = null;
				else if (59 === h && ")" !== d[d.length - 1]) {
					let e = n(u);
					if (!e) throw 0 === u.length ? new Error("Unexpected semicolon") : new Error(`Invalid declaration: \`${u.trim()}\``);
					s ? s.nodes.push(e) : i.push(e), u = ""
				} else if (123 === h && ")" !== d[d.length - 1]) d += "}", c = k(u.trim()), s && s.nodes.push(c), a.push(s), s = c, u = "", c = null;
				else if (125 === h && ")" !== d[d.length - 1]) {
					if ("" === d) throw new Error("Missing opening {");
					if (d = d.slice(0, -1), u.length > 0)
						if (64 === u.charCodeAt(0)) c = r(u), s ? s.nodes.push(c) : i.push(c), u = "", c = null;
						else {
							let e = u.indexOf(":");
							if (s) {
								let t = n(u, e);
		...
		for (let n = 0; n < e.length; n++) {
			let o = e[n],
				...
				a = t(o, {
					parent: r,
					replaceWith(t) {
						i || (i = !0, Array.isArray(t) ? 0 === t.length ? (e.splice(n, 1), l = 0) : 1 === t.length ? (e[n] = t[0], l = 1) : (e.splice(n, 1, ...t), l = t.length) : e[n] = t)
					}
				}) ?? 0;
			if (i) 0 === a ? n-- : n += l - 1;
			else {
		...
		for (let o = 0; o < e.length; o++) {
			...
			let a = !1,
				...
				c = t(i, {
					...
					path: r,
					replaceWith(t) {
						a || (a = !0, Array.isArray(t) ? 0 === t.length ? (e.splice(o, 1), s = 0) : 1 === t.length ? (e[o] = t[0], s = 1) : (e.splice(o, 1, ...t), s = t.length) : (e[o] = t, s = 1))
					}
				}) ?? 0;
			if (r.pop(), a) 0 === c ? o-- : o += s - 1;
			else {
				if (2 === c) return 2;
				if (1 !== c && "nodes" in i) {
					r.push(i);
	...
	function C(e, t, r = [], n = {}) {
		for (let o = 0; o < e.length; o++) {
			let i = e[o],
				l = r[r.length - 1] ?? null;
			if ("rule" === i.kind || "at-rule" === i.kind) r.push(i), C(i.nodes, t, r, n), r.pop();
	...
	function T(e, t) {
		...
		function s(e, c, u = {}, d = 0) {
			if ("declaration" === e.kind) {
				...
				if (u.theme && "-" === e.property[0] && "-" === e.property[1]) {
					if ("initial" === e.value) return void(e.value = void 0);
					u.keyframes || o.get(c).add(e)
				}
				if (e.value.includes("var("))
					if (u.theme && "-" === e.property[0] && "-" === e.property[1])
						for (let t of g(e.value)) a.get(t).add(e.property);
					else t.trackUsedVariables(e.value);
				if ("animation" === e.property)
					for (let t of E(e.value)) l.add(t);
				c.push(e)
			} else if ("rule" === e.kind)
				if ("&" === e.selector)
		...
		e: for (let [e, r] of o)
			for (let n of r) {
				...
				if (e.splice(r, 1), 0 === e.length) {
					let t = S(u, (t => "rule" === t.kind && t.nodes === e));
	...
	function W(e) {
		...
		return D(t), e = function(e) {
			...
			let t = !1;
			N.some((t => e.includes(t))) && (O.lastIndex = 0, e = e.replace(O, ((e, r) => (t = !0, `$${N.indexOf(r)}$(`))));
			let r = "",
				n = [];
		...
		for (let t of e) switch (t.kind) {
			case "function":
				...
				if ("var" === t.value || t.value.endsWith("_var") || "theme" === t.value || t.value.endsWith("_theme")) {
					t.value = U(t.value);
					for (let e = 0; e < t.nodes.length; e++) 0 != e || "word" !== t.nodes[e].kind ? D([t.nodes[e]]) : t.nodes[e].value = U(t.nodes[e].value, !0);
					break
				}
	...
	function M(e) {
		if ("[" === e[0] && "]" === e[e.length - 1]) {
			let t = W(e.slice(1, -1));
			return 0 === t.length || 0 === t.trim().length ? null : {
				kind: "arbitrary",
				value: t
			}
		}
	...
	var H = {
		...
		"bg-size": function(e) {
			...
			for (let r of L(e, ",")) {
				...
				e.every((e => "auto" === e || le(e) || ne(e))) && (t += 1)
			}
			return t > 0
		},
		"line-width": function(e) {
			return L(e, " ").every((e => le(e) || te(e) || "thin" === e || "medium" === e || "thick" === e))
		},
		image: function(e) {
			let t = 0;
			for (let r of L(e, ","))
	...
	var X = /^(?:element|image|cross-fade|image-set)\(/,
		J = /^(repeating-)?(conic|linear|radial)-gradient\(/;
	var Q = /[+-]?\d*\.?\d+(?:[eE][+-]?\d+)?/,
		ee = new RegExp(`^${Q.source}$`);

	function te(e) {
		return ee.test(e) || F(e)
	}
	var re = new RegExp(`^${Q.source}%$`);

	function ne(e) {
		return re.test(e) || F(e)
	}
	var oe = new RegExp(`^${Q.source}s*/s*${Q.source}$`);
	var ie = new RegExp(`^${Q.source}(${["cm","mm","Q","in","pc","pt","px","em","ex","ch","rem","lh","rlh","vw","vh","vmin","vmax","vb","vi","svw","svh","lvw","lvh","dvw","dvh","cqw","cqh","cqi","cqb","cqmin","cqmax"].join("|")})$`);

	function le(e) {
		return ie.test(e) || F(e)
	}
	var ae = new RegExp(`^${Q.source}(${["deg","rad","grad","turn"].join("|")})$`);
	var se = new RegExp(`^${Q.source} +${Q.source} +${Q.source}$`);
	...
	var pe = new Set(["inset", "inherit", "initial", "revert", "unset"]),
		me = /^-?(\d+|\.\d+)(.*?)$/g;
	...
	function ge(e, t) {
		return L(e, ",").map((e => {
			let r = L(e = e.trim(), " ").filter((e => "" !== e.trim())),
				...
				o = null,
				i = null;
			for (let e of r) pe.has(e) || (me.test(e) ? (null === o ? o = e : null === i && (i = e), me.lastIndex = 0) : null === n && (n = e));
			if (null === o || null === i) return e;
			let l = t(n ?? "currentcolor");
			return null !== n ? e.replace(n, l) : `${e} ${l}`
		})).join(", ")
	}
	var ve = /^-?[a-z][a-zA-Z0-9/%._-]*$/,
		be = /^-?[a-z][a-zA-Z0-9/%._-]*-\*$/,
		we = ["0", "0.5", "1", "1.5", "2", "2.5", "3", "3.5", "4", "5", "6", "7", "8", "9", "10", "11", "12", "14", "16", "20", "24", "28", "32", "36", "40", "44", "48", "52", "56", "60", "64", "72", "80", "96"],
		ke = class {
			utilities = new c((() => []));
			completions = new Map;
			static(e, t) {
	...
	function $e(e, t, r) {
		if (!t) return e;
		if ("arbitrary" === t.kind) return xe(e, t.value);
		let n = r.resolve(t.value, ["--opacity"]);
		return n ? xe(e, n) : fe(t.value) ? xe(e, `${t.value}%`) : null
	}
	...
	function Ae(e, t, r) {
		...
		return n ? $e(n, e.modifier, t) : null
	}

	function ze(e, t, r) {
		for (let n of t.nodes) {
			if ("named" === e.kind && "word" === n.kind && ("'" === n.value[0] || '"' === n.value[0]) && n.value[n.value.length - 1] === n.value[0] && n.value.slice(1, -1) === e.value) return {
				nodes: m(e.value)
			};
	...
	var Te = new RegExp(Object.keys(Ce).map((e => `${e}\\(`)).join("|"));

	function je(e, t) {
		let r = 0;
		return z(e, (e => {
			if ("declaration" === e.kind && e.value && Te.test(e.value)) return r |= 8, void(e.value = Se(e.value, e, t));
			"at-rule" === e.kind && ("@media" === e.name || "@custom-media" === e.name || "@container" === e.name || "@supports" === e.name) && Te.test(e.params) && (r |= 8, e.params = Se(e.params, e, t))
		})), r
	}
	...
	function Se(e, t, r) {
		...
		return h(n, ((e, {
			...
			if ("function" === e.kind && e.value in Ce) {
				let o = L(p(e.nodes).trim(), ",").map((e => e.trim()));
				return n(m(Ce[e.value](r, t, ...o)))
			}
		})), p(n)
	}
	...
	function Ve(e) {
		let t = [];
		for (let r of e.utilities.keys("static")) t.push({
			name: r,
			utility: r,
			fraction: !1,
			modifiers: []
		...
		return 0 === t.length ? [] : (t.sort(((e, t) => Ke(e.name, t.name))), function(e) {
			let t = [],
				r = null,
				n = new Map,
				o = new c((() => []));
			for (let i of e) {
				...
				r || (r = {
					utility: e,
					items: []
				}, n.set(e, r)), e !== r.utility && (t.push(r), r = {
					utility: e,
					items: []
			...
			let i = [];
			for (let e of t)
				for (let t of e.items) i.push([t.name, {
	...
	function Ue(e, t) {
		z(e, ((e, {
			...
			else if ("at-rule" === e.kind && ("@keyframes" === e.name || "@property" === e.name)) return Object.assign(e, A([w(e.name, e.params, e.nodes)])), 1
		}))
	}
		...
		let t = function(e) {
				...
				function i(n, o) {
					t.functional(n, (t => {
						if (!t.value) return;
						let r = null;
						return "arbitrary" === t.value.kind ? (r = t.value.value, r = $e(r, t.modifier, e)) : r = Ae(t, e, o.themeKeys), null !== r ? o.handle(r) : void 0
					})), r(n, (() => [{
				...
				n("box-border", [
				...
				]), n("table-column-group", [
					["display", "table-column-group"]
				]), n("table-footer-group", [
					...
					["display", "list-item"]
				]), n("field-sizing-content", [
					["field-sizing", "content"]
				]), n("field-sizing-fixed", [
					["field-sizing", "fixed"]
				]), n("aspect-auto", [
					["aspect-ratio", "auto"]
				]), n("aspect-square", [
				...
				n("w-screen", [
					...
					["max-height", "none"]
				]), l("size", ["--size", "--spacing"], (e => [y("--tw-sort", "size"), y("width", e), y("height", e)]), {
					supportsFractions: !0
				});
				for (let [e, t, r] of [
				...
				t.static("container", (() => {
					...
					if (e.value) {
						...
						if (e.value.fraction) {
							...
							return ce(t) && ce(r) ? [y("flex", `calc(${e.value.fraction} * 100%)`)] : void 0
						}
						if (ce(e.value.value)) return e.modifier ? void 0 : [y("flex", e.value.value)]
					}
				})), r("flex", (() => [{
					supportsFractions: !0
				}])), o("shrink", {
					...
					["flex-basis", "100%"]
				]), l("basis", ["--flex-basis", "--spacing", "--container"], (e => [y("flex-basis", e)]), {
					supportsFractions: !0
				}), n("table-auto", [
					["table-layout", "auto"]
				]), n("table-fixed", [
				...
				let a = () => A([ye("--tw-border-spacing-x", "0", "<length>"), ye("--tw-border-spacing-y", "0", "<length>")]);
				...
				]), n("origin-bottom-right", [
					["transform-origin", "bottom right"]
				]), n("origin-bottom", [
					["transform-origin", "bottom"]
				]), n("origin-bottom-left", [
				...
				let s = () => A([ye("--tw-translate-x", "0"), ye("--tw-translate-y", "0"), ye("--tw-translate-z", "0")]);
				n("translate-none", [
					["translate", "none"]
				]), n("-translate-full", [s, ["--tw-translate-x", "-100%"],
					["--tw-translate-y", "-100%"],
					["translate", "var(--tw-translate-x) var(--tw-translate-y)"]
				]), n("translate-full", [s, ["--tw-translate-x", "100%"],
					["--tw-translate-y", "100%"],
					["translate", "var(--tw-translate-x) var(--tw-translate-y)"]
				]), l("translate", ["--translate", "--spacing"], (e => [s(), y("--tw-translate-x", e), y("--tw-translate-y", e), y("translate", "var(--tw-translate-x) var(--tw-translate-y)")]), {
					supportsNegative: !0,
					supportsFractions: !0
				});
				for (let e of ["x", "y"]) n(`-translate-${e}-full`, [s, [`--tw-translate-${e}`, "-100%"],
					["translate", "var(--tw-translate-x) var(--tw-translate-y)"]
				]), n(`translate-${e}-full`, [s, [`--tw-translate-${e}`, "100%"],
					["translate", "var(--tw-translate-x) var(--tw-translate-y)"]
				]), l(`translate-${e}`, ["--translate", "--spacing"], (t => [s(), y(`--tw-translate-${e}`, t), y("translate", "var(--tw-translate-x) var(--tw-translate-y)")]), {
					supportsNegative: !0,
					supportsFractions: !0
				});
				l("translate-z", ["--translate", "--spacing"], (e => [s(), y("--tw-translate-z", e), y("translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)")]), {
					supportsNegative: !0
				}), n("translate-3d", [s, ["translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)"]]);
				let c = () => A([ye("--tw-scale-x", "1"), ye("--tw-scale-y", "1"), ye("--tw-scale-z", "1")]);
				...
				function u({
					...
					return r => {
						...
						let n;
						return "arbitrary" === r.value.kind ? (n = r.value.value, [y("scale", n)]) : (n = e.resolve(r.value.value, ["--scale"]), !n && ce(r.value.value) && (n = `${r.value.value}%`), n ? (n = t ? `calc(${n} * -1)` : n, [c(), y("--tw-scale-x", n), y("--tw-scale-y", n), y("--tw-scale-z", n), y("scale", "var(--tw-scale-x) var(--tw-scale-y)")]) : void 0)
					}
				}
				n("scale-none", [
					["scale", "none"]
				...
				function d({
					...
					return r => {
						...
						if ("arbitrary" === r.value.kind) {
							n = r.value.value;
							let e = r.value.dataType ?? Y(n, ["angle", "vector"]);
							if ("vector" === e) return [y("rotate", `${n} var(--tw-rotate)`)];
							if ("angle" !== e) return [y("rotate", n)]
						} else if (n = e.resolve(r.value.value, ["--rotate"]), !n && ce(r.value.value) && (n = `${r.value.value}deg`), !n) return;
						return [y("rotate", t ? `calc(${n} * -1)` : n)]
					}
				}
				n("scale-3d", [c, ["scale", "var(--tw-scale-x) var(--tw-scale-y) var(--tw-scale-z)"]]), n("rotate-none", [
					["rotate", "none"]
				...
				}]));
				{
					let e = ["var(--tw-rotate-x)", "var(--tw-rotate-y)", "var(--tw-rotate-z)", "var(--tw-skew-x)", "var(--tw-skew-y)"].join(" "),
						i = () => A([ye("--tw-rotate-x", "rotateX(0)"), ye("--tw-rotate-y", "rotateY(0)"), ye("--tw-rotate-z", "rotateZ(0)"), ye("--tw-skew-x", "skewX(0)"), ye("--tw-skew-y", "skewY(0)")]);
				...
				for (let e of ["auto", "none", "manipulation"]) n(`touch-${e}`, [
					["touch-action", e]
				]);
				let f = () => A([ye("--tw-pan-x"), ye("--tw-pan-y"), ye("--tw-pinch-zoom")]);
				for (let e of ["x", "left", "right"]) n(`touch-pan-${e}`, [f, ["--tw-pan-x", `pan-${e}`],
					["touch-action", "var(--tw-pan-x,) var(--tw-pan-y,) var(--tw-pinch-zoom,)"]
				]);
				for (let e of ["y", "up", "down"]) n(`touch-pan-${e}`, [f, ["--tw-pan-y", `pan-${e}`],
					["touch-action", "var(--tw-pan-x,) var(--tw-pan-y,) var(--tw-pinch-zoom,)"]
				]);
				n("touch-pinch-zoom", [f, ["--tw-pinch-zoom", "pinch-zoom"],
					["touch-action", "var(--tw-pan-x,) var(--tw-pan-y,) var(--tw-pinch-zoom,)"]
				]);
				for (let e of ["none", "text", "all", "auto"]) n(`select-${e}`, [
				...
				let h = () => A([ye("--tw-scroll-snap-strictness", "proximity", "*")]);
				for (let e of ["x", "y", "both"]) n(`snap-${e}`, [h, ["scroll-snap-type", `${e} var(--tw-scroll-snap-strictness)`]]);
				n("snap-mandatory", [h, ["--tw-scroll-snap-strictness", "mandatory"]]), n("snap-proximity", [h, ["--tw-scroll-snap-strictness", "proximity"]]), n("snap-align-none", [
				...
				for (let [e, t] of [
					...
					]) l(e, ["--scroll-margin", "--spacing"], (e => [y(t, e)]), {
					supportsNegative: !0
				});
				for (let [e, t] of [
					...
					]) l(e, ["--scroll-padding", "--spacing"], (e => [y(t, e)]));
				n("list-inside", [
				...
				for (let e of ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"]) n(`break-before-${e}`, [
					["break-before", e]
				]);
				for (let e of ["auto", "avoid", "avoid-page", "avoid-column"]) n(`break-inside-${e}`, [
					["break-inside", e]
				]);
				for (let e of ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"]) n(`break-after-${e}`, [
					["break-after", e]
				]);
				n("grid-flow-row", [
					["grid-auto-flow", "row"]
				...
				]), n("grid-flow-row-dense", [
					["grid-auto-flow", "row dense"]
				]), n("grid-flow-col-dense", [
					...
					handleBareValue: ({
						value: e
					}) => ue(e) ? `repeat(${e}, minmax(0, 1fr))` : null,
				...
				]), n("place-content-center", [
					["place-content", "center"]
				]), n("place-content-start", [
					["place-content", "start"]
				]), n("place-content-end", [
					["place-content", "end"]
				]), n("place-content-between", [
					["place-content", "space-between"]
				]), n("place-content-around", [
					["place-content", "space-around"]
				]), n("place-content-evenly", [
					["place-content", "space-evenly"]
				]), n("place-content-baseline", [
					["place-content", "baseline"]
				]), n("place-content-stretch", [
					...
					["place-items", "end"]
				]), n("place-items-baseline", [
					["place-items", "baseline"]
				]), n("place-items-stretch", [
					["place-items", "stretch"]
				]), n("content-normal", [
				...
				]), l("gap", ["--gap", "--spacing"], (e => [y("gap", e)])), l("gap-x", ["--gap", "--spacing"], (e => [y("column-gap", e)])), l("gap-y", ["--gap", "--spacing"], (e => [y("row-gap", e)])), l("space-x", ["--space", "--spacing"], (e => [A([ye("--tw-space-x-reverse", "0")]), b(":where(& > :not(:last-child))", [y("--tw-sort", "row-gap"), y("--tw-space-x-reverse", "0"), y("margin-inline-start", `calc(${e} * var(--tw-space-x-reverse))`), y("margin-inline-end", `calc(${e} * calc(1 - var(--tw-space-x-reverse)))`)])]), {
					supportsNegative: !0
				}), l("space-y", ["--space", "--spacing"], (e => [A([ye("--tw-space-y-reverse", "0")]), b(":where(& > :not(:last-child))", [y("--tw-sort", "column-gap"), y("--tw-space-y-reverse", "0"), y("margin-block-start", `calc(${e} * var(--tw-space-y-reverse))`), y("margin-block-end", `calc(${e} * calc(1 - var(--tw-space-y-reverse)))`)])]), {
					supportsNegative: !0
				}), n("space-x-reverse", [() => A([ye("--tw-space-x-reverse", "0")]), () => b(":where(& > :not(:last-child))", [y("--tw-sort", "row-gap"), y("--tw-space-x-reverse", "1")])]), n("space-y-reverse", [() => A([ye("--tw-space-y-reverse", "0")]), () => b(":where(& > :not(:last-child))", [y("--tw-sort", "column-gap"), y("--tw-space-y-reverse", "1")])]), n("accent-auto", [
					["accent-color", "auto"]
				]), i("accent", {
					...
					["justify-self", "center"]
				]), n("justify-self-stretch", [
					["justify-self", "stretch"]
				]);
				for (let e of ["auto", "hidden", "clip", "visible", "scroll"]) n(`overflow-${e}`, [
					["overflow", e]
				]), n(`overflow-x-${e}`, [
					["overflow-x", e]
				]), n(`overflow-y-${e}`, [
				...
				for (let e of ["auto", "contain", "none"]) n(`overscroll-${e}`, [
					["overscroll-behavior", e]
				]), n(`overscroll-x-${e}`, [
					["overscroll-behavior-x", e]
				]), n(`overscroll-y-${e}`, [
					["overscroll-behavior-y", e]
				]);
				n("scroll-auto", [
					...
					["white-space", "pre"]
				]), n("whitespace-pre-line", [
					["white-space", "pre-line"]
				]), n("whitespace-pre-wrap", [
					["white-space", "pre-wrap"]
				]), n("whitespace-break-spaces", [
				...
				for (let [e, t] of [
					...
					]) n(`${e}-none`, t.map((e => [e, "0"]))), n(`${e}-full`, t.map((e => [e, "calc(infinity * 1px)"]))), o(e, {
					themeKeys: ["--radius"],
				...
				]);
				{
					let i = function(n, o) {
							t.functional(n, (t => {
								...
								if ("arbitrary" === t.value.kind) {
									let r = t.value.value;
									switch (t.value.dataType ?? Y(r, ["color", "line-width", "length"])) {
										case "line-width":
										case "length": {
											if (t.modifier) return;
											let e = o.width(r);
										...
										default:
											return r = $e(r, t.modifier, e), null === r ? void 0 : o.color(r)
									}
								} {
									let r = Ae(t, e, ["--border-color", "--color"]);
					...
					i("border", {
						...
						handle: e => [A([ye("--tw-divide-x-reverse", "0")]), b(":where(& > :not(:last-child))", [y("--tw-sort", "divide-x-width"), l(), y("--tw-divide-x-reverse", "0"), y("border-inline-style", "var(--tw-border-style)"), y("border-inline-start-width", `calc(${e} * var(--tw-divide-x-reverse))`), y("border-inline-end-width", `calc(${e} * calc(1 - var(--tw-divide-x-reverse)))`)])]
					}), o("divide-y", {
						defaultValue: e.get(["--default-border-width"]) ?? "1px",
						themeKeys: ["--divide-width", "--border-width"],
						handleBareValue: ({
						...
						handle: e => [A([ye("--tw-divide-y-reverse", "0")]), b(":where(& > :not(:last-child))", [y("--tw-sort", "divide-y-width"), l(), y("--tw-divide-y-reverse", "0"), y("border-bottom-style", "var(--tw-border-style)"), y("border-top-style", "var(--tw-border-style)"), y("border-top-width", `calc(${e} * var(--tw-divide-y-reverse))`), y("border-bottom-width", `calc(${e} * calc(1 - var(--tw-divide-y-reverse)))`)])]
					}), r("divide-x", (() => [{
						values: ["0", "2", "4", "8"],
						...
						valueThemeKeys: ["--divide-width", "--border-width"],
						hasDefaultValue: !0
					}])), n("divide-x-reverse", [() => A([ye("--tw-divide-x-reverse", "0")]), () => b(":where(& > :not(:last-child))", [y("--tw-divide-x-reverse", "1")])]), n("divide-y-reverse", [() => A([ye("--tw-divide-y-reverse", "0")]), () => b(":where(& > :not(:last-child))", [y("--tw-divide-y-reverse", "1")])]);
					...
					let e = function(e) {
						...
						n = function({
							...
							return r => {
								...
								if ("arbitrary" === r.value.kind) {
									if (r.modifier) return;
									let e = r.value.value;
									return "angle" === (r.value.dataType ?? Y(e, ["angle"])) ? (e = t ? `calc(${e} * -1)` : `${e}`, [y("--tw-gradient-position", e), y("background-image", `linear-gradient(var(--tw-gradient-stops,${e}))`)]) : t ? void 0 : [y("--tw-gradient-position", e), y("background-image", `linear-gradient(var(--tw-gradient-stops,${e}))`)]
								}
								let n = r.value.value;
								if (!t && l.has(n)) n = l.get(n);
								else {
									if (!ce(n)) return;
						...
						o = function({
							...
							return r => {
								...
								let o = r.value.value;
								return ce(o) ? (o = t ? `calc(${o}deg * -1)` : `${o}deg`, [y("--tw-gradient-position", `from ${o} ${n}`), y("background-image", "conic-gradient(var(--tw-gradient-stops))")]) : void 0
							}
						},
				...
				t.functional("bg", (t => {
					if (t.value) {
						if ("arbitrary" === t.value.kind) {
							let r = t.value.value;
							switch (t.value.dataType ?? Y(r, ["image", "color", "percentage", "position", "bg-size", "length", "url"])) {
								case "percentage":
								case "position":
								...
								default:
									return r = $e(r, t.modifier, e), null === r ? void 0 : [y("background-color", r)]
							}
						} {
							let r = Ae(t, e, ["--background-color", "--color"]);
				...
				let p = () => A([ye("--tw-gradient-position"), ye("--tw-gradient-from", "#0000", "<color>"), ye("--tw-gradient-via", "#0000", "<color>"), ye("--tw-gradient-to", "#0000", "<color>"), ye("--tw-gradient-stops"), ye("--tw-gradient-via-stops"), ye("--tw-gradient-from-position", "0%", "<length-percentage>"), ye("--tw-gradient-via-position", "50%", "<length-percentage>"), ye("--tw-gradient-to-position", "100%", "<length-percentage>")]);
				...
				function m(n, o) {
					t.functional(n, (t => {
						if (t.value) {
							if ("arbitrary" === t.value.kind) {
								let r = t.value.value;
								switch (t.value.dataType ?? Y(r, ["color", "length", "percentage"])) {
									case "length":
									case "percentage":
								...
								if ("%" === t.value.value[t.value.value.length - 1] && ce(t.value.value.slice(0, -1))) return o.position(t.value.value)
							}
						}
					})), r(n, (() => [{
						values: ["current", "inherit", "transparent"],
				...
				for (let e of ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"]) n(`bg-blend-${e}`, [
					["background-blend-mode", e]
				]), n(`mix-blend-${e}`, [
					["mix-blend-mode", e]
				]);
				n("mix-blend-plus-darker", [
					["mix-blend-mode", "plus-darker"]
				]), n("mix-blend-plus-lighter", [
					...
					if (!t.value) return;
					if ("arbitrary" === t.value.kind) {
						let r = $e(t.value.value, t.modifier, e);
						return null === r ? void 0 : [y("fill", r)]
					}
					let r = Ae(t, e, ["--fill", "--color"]);
					...
					if (t.value) {
						if ("arbitrary" === t.value.kind) {
							let r = t.value.value;
							switch (t.value.dataType ?? Y(r, ["color", "number", "length", "percentage"])) {
								case "number":
								case "length":
								case "percentage":
									return t.modifier ? void 0 : [y("stroke-width", r)];
								default:
									return r = $e(t.value.value, t.modifier, e), null === r ? void 0 : [y("stroke", r)]
							}
						} {
							let r = Ae(t, e, ["--stroke", "--color"]);
							if (r) return [y("stroke", r)]
						} {
							let r = e.resolve(t.value.value, ["--stroke-width"]);
							if (r) return [y("stroke-width", r)];
							if (ce(t.value.value)) return [y("stroke-width", t.value.value)]
						}
					}
				})), r("stroke", (() => [{
					values: ["current", "inherit", "transparent"],
				...
				]), n("object-left-bottom", [
					["object-position", "left bottom"]
				]), n("object-left-top", [
					["object-position", "left top"]
				]), n("object-right", [
					["object-position", "right"]
				]), n("object-right-bottom", [
				...
				n("text-left", [
					...
					["text-align", "end"]
				]), l("indent", ["--text-indent", "--spacing"], (e => [y("text-indent", e)]), {
					supportsNegative: !0
				}), n("align-baseline", [
					...
					if (t.value && !t.modifier) {
						if ("arbitrary" === t.value.kind) {
							let e = t.value.value;
							switch (t.value.dataType ?? Y(e, ["number", "generic-name", "family-name"])) {
								case "generic-name":
								case "family-name":
									return [y("font-family", e)];
								default:
									return [A([ye("--tw-font-weight")]), y("--tw-font-weight", e), y("font-weight", e)]
							}
						} {
							...
							if (r) return [A([ye("--tw-font-weight")]), y("--tw-font-weight", r), y("font-weight", r)]
						}
					}
				})), r("font", (() => [{
					values: [],
				...
				]), n("font-stretch-condensed", [
					["font-stretch", "condensed"]
				]), n("font-stretch-semi-condensed", [
					["font-stretch", "semi-condensed"]
				]), n("font-stretch-semi-expanded", [
					["font-stretch", "semi-expanded"]
				]), n("font-stretch-expanded", [
					...
					if (t.value) {
						if ("arbitrary" === t.value.kind) {
							...
							switch (t.value.dataType ?? Y(r, ["color", "length", "percentage"])) {
								...
								default:
									return r = $e(r, t.modifier, e), null === r ? void 0 : [y("text-decoration-color", r)]
							}
						} {
							let r = e.resolve(t.value.value, ["--text-decoration-thickness"]);
							if (r) return t.modifier ? void 0 : [y("text-decoration-thickness", r)];
							if (ce(t.value.value)) return t.modifier ? void 0 : [y("text-decoration-thickness", `${t.value.value}px`)]
						} {
							let r = Ae(t, e, ["--text-decoration-color", "--color"]);
				...
				});
				{
					let e = ["var(--tw-blur,)", "var(--tw-brightness,)", "var(--tw-contrast,)", "var(--tw-grayscale,)", "var(--tw-hue-rotate,)", "var(--tw-invert,)", "var(--tw-saturate,)", "var(--tw-sepia,)", "var(--tw-drop-shadow,)"].join(" "),
						...
						l = () => A([ye("--tw-blur"), ye("--tw-brightness"), ye("--tw-contrast"), ye("--tw-grayscale"), ye("--tw-hue-rotate"), ye("--tw-invert"), ye("--tw-opacity"), ye("--tw-saturate"), ye("--tw-sepia"), ye("--tw-drop-shadow")]),
						a = () => A([ye("--tw-backdrop-blur"), ye("--tw-backdrop-brightness"), ye("--tw-backdrop-contrast"), ye("--tw-backdrop-grayscale"), ye("--tw-backdrop-hue-rotate"), ye("--tw-backdrop-invert"), ye("--tw-backdrop-opacity"), ye("--tw-backdrop-saturate"), ye("--tw-backdrop-sepia")]);
					t.functional("filter", (t => {
						...
						hasDefaultValue: !0
					}])), n("drop-shadow-none", [l, ["--tw-drop-shadow", " "],
						["filter", e]
					]), o("drop-shadow", {
						themeKeys: ["--drop-shadow"],
						handle: t => [l(), y("--tw-drop-shadow", L(t, ",").map((e => `drop-shadow(${e})`)).join(" ")), y("filter", e)]
					}), o("backdrop-opacity", {
					...
					{
						let r = () => A([ye("--tw-duration")]);
						n("duration-initial", [r, ["--tw-duration", "initial"]]), t.functional("duration", (t => {
							if (t.modifier || !t.value) return;
							let n = null;
							return "arbitrary" === t.value.kind ? n = t.value.value : (n = e.resolve(t.value.fraction ?? t.value.value, ["--transition-duration"]), null === n && ce(t.value.value) && (n = `${t.value.value}ms`)), null !== n ? [r(), y("--tw-duration", n), y("transition-duration", n)] : void 0
						}))
					}
					r("delay", (() => [{
					...
					let e = () => A([ye("--tw-ease")]);
					n("ease-initial", [e, ["--tw-ease", "initial"]]), n("ease-linear", [e, ["--tw-ease", "linear"],
				...
				n("will-change-auto", [
					["will-change", "auto"]
				]), n("will-change-scroll", [
					["will-change", "scroll-position"]
				]), n("will-change-contents", [
					...
					themeKeys: [],
					handle: e => [A([ye("--tw-content", '""')]), y("--tw-content", e), y("content", "var(--tw-content)")]
				});
				{
					let e = "var(--tw-contain-size,) var(--tw-contain-layout,) var(--tw-contain-paint,) var(--tw-contain-style,)",
						t = () => A([ye("--tw-contain-size"), ye("--tw-contain-layout"), ye("--tw-contain-paint"), ye("--tw-contain-style")]);
					n("contain-none", [
						["contain", "none"]
					]), n("contain-content", [
						["contain", "content"]
						...
						["contain", "strict"]
					]), n("contain-size", [t, ["--tw-contain-size", "size"],
						["contain", e]
					]), n("contain-inline-size", [t, ["--tw-contain-size", "inline-size"],
						["contain", e]
					]), n("contain-layout", [t, ["--tw-contain-layout", "layout"],
						["contain", e]
					]), n("contain-paint", [t, ["--tw-contain-paint", "paint"],
						["contain", e]
					]), n("contain-style", [t, ["--tw-contain-style", "style"],
						["contain", e]
					]), o("contain", {
						themeKeys: [],
				...
				n("forced-color-adjust-none", [
					["forced-color-adjust", "none"]
				]), n("forced-color-adjust-auto", [
					["forced-color-adjust", "auto"]
				]), n("leading-none", [() => A([ye("--tw-leading")]), ["--tw-leading", "1"],
					["line-height", "1"]
				]), l("leading", ["--leading", "--spacing"], (e => [A([ye("--tw-leading")]), y("--tw-leading", e), y("line-height", e)])), o("tracking", {
					supportsNegative: !0,
					themeKeys: ["--tracking"],
					handle: e => [A([ye("--tw-tracking")]), y("--tw-tracking", e), y("letter-spacing", e)]
				}), n("antialiased", [
				...
				]);
				{
					let e = "var(--tw-ordinal,) var(--tw-slashed-zero,) var(--tw-numeric-figure,) var(--tw-numeric-spacing,) var(--tw-numeric-fraction,)",
						t = () => A([ye("--tw-ordinal"), ye("--tw-slashed-zero"), ye("--tw-numeric-figure"), ye("--tw-numeric-spacing"), ye("--tw-numeric-fraction")]);
					n("normal-nums", [
						["font-variant-numeric", "normal"]
					]), n("ordinal", [t, ["--tw-ordinal", "ordinal"],
						["font-variant-numeric", e]
					]), n("slashed-zero", [t, ["--tw-slashed-zero", "slashed-zero"],
						["font-variant-numeric", e]
					]), n("lining-nums", [t, ["--tw-numeric-figure", "lining-nums"],
						["font-variant-numeric", e]
					]), n("oldstyle-nums", [t, ["--tw-numeric-figure", "oldstyle-nums"],
						["font-variant-numeric", e]
					]), n("proportional-nums", [t, ["--tw-numeric-spacing", "proportional-nums"],
						["font-variant-numeric", e]
					]), n("tabular-nums", [t, ["--tw-numeric-spacing", "tabular-nums"],
						["font-variant-numeric", e]
					]), n("diagonal-fractions", [t, ["--tw-numeric-fraction", "diagonal-fractions"],
						["font-variant-numeric", e]
					]), n("stacked-fractions", [t, ["--tw-numeric-fraction", "stacked-fractions"],
						["font-variant-numeric", e]
					])
				} {
					let i = () => A([ye("--tw-outline-style", "solid")]);
					t.static("outline-hidden", (() => [y("--tw-outline-style", "none"), y("outline-style", "none"), w("@media", "(forced-colors: active)", [y("outline", "2px solid transparent"), y("outline-offset", "2px")])])), n("outline-none", [
						...
						if ("arbitrary" === t.value.kind) {
							let r = t.value.value;
							switch (t.value.dataType ?? Y(r, ["color", "length", "number", "percentage"])) {
								case "length":
								case "number":
								case "percentage":
									return t.modifier ? void 0 : [i(), y("outline-style", "var(--tw-outline-style)"), y("outline-width", r)];
								default:
									return r = $e(r, t.modifier, e), null === r ? void 0 : [y("outline-color", r)]
							}
						} {
							let r = Ae(t, e, ["--outline-color", "--color"]);
							...
							if (ce(t.value.value)) return [i(), y("outline-style", "var(--tw-outline-style)"), y("outline-width", `${t.value.value}px`)]
						}
					})), r("outline", (() => [{
						values: ["current", "inherit", "transparent"],
				...
				o("opacity", {
					...
					if (t.value) {
						if ("arbitrary" === t.value.kind) {
							let r = t.value.value;
							switch (t.value.dataType ?? Y(r, ["color", "length", "percentage", "absolute-size", "relative-size"])) {
								case "size":
								case "length":
								case "percentage":
								case "absolute-size":
								...
								default:
									return r = $e(r, t.modifier, e), null === r ? void 0 : [y("color", r)]
							}
						} {
							let r = Ae(t, e, ["--text-color", "--color"]);
				...
				}]));
				{
					let o = function(e) {
						...
						a = "0 0 #0000",
						s = () => A([ye("--tw-shadow", a), ye("--tw-shadow-color"), ye("--tw-inset-shadow", a), ye("--tw-inset-shadow-color"), ye("--tw-ring-color"), ye("--tw-ring-shadow", a), ye("--tw-inset-ring-color"), ye("--tw-inset-ring-shadow", a), ye("--tw-ring-inset"), ye("--tw-ring-offset-width", "0px", "<length>"), ye("--tw-ring-offset-color", "#fff"), ye("--tw-ring-offset-shadow", a)]);
					n("shadow-initial", [s, ["--tw-shadow-color", "initial"]]), t.functional("shadow", (t => {
						if (!t.value) {
							let t = e.get(["--shadow"]);
							return null === t ? void 0 : [s(), y("--tw-shadow", ge(t, (e => `var(--tw-shadow-color, ${e})`))), y("box-shadow", l)]
						}
						if ("arbitrary" === t.value.kind) {
							let r = t.value.value;
							return "color" === (t.value.dataType ?? Y(r, ["color"])) ? (r = $e(r, t.modifier, e), null === r ? void 0 : [s(), y("--tw-shadow-color", r)]) : [s(), y("--tw-shadow", ge(r, (e => `var(--tw-shadow-color, ${e})`))), y("box-shadow", l)]
						}
						if ("none" === t.value.value) return t.modifier ? void 0 : [s(), y("--tw-shadow", a), y("box-shadow", l)];
						{
							let r = e.get([`--shadow-${t.value.value}`]);
							if (r) return t.modifier ? void 0 : [s(), y("--tw-shadow", ge(r, (e => `var(--tw-shadow-color, ${e})`))), y("box-shadow", l)]
						} {
							let r = Ae(t, e, ["--box-shadow-color", "--color"]);
						...
						if (!t.value) {
							...
							return null === t ? void 0 : [s(), y("--tw-inset-shadow", ge(t, (e => `var(--tw-inset-shadow-color, ${e})`))), y("box-shadow", l)]
						}
						if ("arbitrary" === t.value.kind) {
							let r = t.value.value;
							return "color" === (t.value.dataType ?? Y(r, ["color"])) ? (r = $e(r, t.modifier, e), null === r ? void 0 : [s(), y("--tw-inset-shadow-color", r)]) : [s(), y("--tw-inset-shadow", `inset ${ge(r,(e=>`var(--tw-inset-shadow-color, ${e})`))}`), y("box-shadow", l)]
						}
						if ("none" === t.value.value) return t.modifier ? void 0 : [s(), y("--tw-inset-shadow", a), y("box-shadow", l)];
						{
							...
							if (r) return t.modifier ? void 0 : [s(), y("--tw-inset-shadow", ge(r, (e => `var(--tw-inset-shadow-color, ${e})`))), y("box-shadow", l)]
						} {
							let r = Ae(t, e, ["--box-shadow-color", "--color"]);
					...
					t.functional("ring", (t => {
						...
						if ("arbitrary" === t.value.kind) {
							let r = t.value.value;
							return "length" === (t.value.dataType ?? Y(r, ["color", "length"])) ? t.modifier ? void 0 : [s(), y("--tw-ring-shadow", o(r)), y("box-shadow", l)] : (r = $e(r, t.modifier, e), null === r ? void 0 : [y("--tw-ring-color", r)])
						} {
							let r = Ae(t, e, ["--ring-color", "--color"]);
							if (r) return [y("--tw-ring-color", r)]
						} {
							if (t.modifier) return;
							let r = e.resolve(t.value.value, ["--ring-width"]);
							if (null === r && ce(t.value.value) && (r = `${t.value.value}px`), r) return [s(), y("--tw-ring-shadow", o(r)), y("box-shadow", l)]
						}
					})), r("ring", (() => [{
						values: ["current", "inherit", "transparent"],
						...
						if ("arbitrary" === t.value.kind) {
							let r = t.value.value;
							return "length" === (t.value.dataType ?? Y(r, ["color", "length"])) ? t.modifier ? void 0 : [s(), y("--tw-inset-ring-shadow", i(r)), y("box-shadow", l)] : (r = $e(r, t.modifier, e), null === r ? void 0 : [y("--tw-inset-ring-color", r)])
						} {
							let r = Ae(t, e, ["--ring-color", "--color"]);
							...
							if (t.modifier) return;
							let r = e.resolve(t.value.value, ["--ring-width"]);
							if (null === r && ce(t.value.value) && (r = `${t.value.value}px`), r) return [s(), y("--tw-inset-ring-shadow", i(r)), y("box-shadow", l)]
						}
					})), r("inset-ring", (() => [{
						values: ["current", "inherit", "transparent"],
						valueThemeKeys: ["--ring-color", "--color"],
					...
					t.functional("ring-offset", (t => {
						if (t.value) {
							if ("arbitrary" === t.value.kind) {
								let r = t.value.value;
								return "length" === (t.value.dataType ?? Y(r, ["color", "length"])) ? t.modifier ? void 0 : [y("--tw-ring-offset-width", r), y("--tw-ring-offset-shadow", u)] : (r = $e(r, t.modifier, e), null === r ? void 0 : [y("--tw-ring-offset-color", r)])
							} {
								...
								if (ce(t.value.value)) return t.modifier ? void 0 : [y("--tw-ring-offset-width", `${t.value.value}px`), y("--tw-ring-offset-shadow", u)]
							} {
								let r = Ae(t, e, ["--ring-offset-color", "--color"]);
			...
			r = function(e) {
				...
				r("first", ["&:first-child"]), r("last", ["&:last-child"]), r("only", ["&:only-child"]), r("odd", ["&:nth-child(odd)"]), r("even", ["&:nth-child(even)"]), r("first-of-type", ["&:first-of-type"]), r("last-of-type", ["&:last-of-type"]), r("only-of-type", ["&:only-of-type"]), r("visited", ["&:visited"]), r("target", ["&:target"]), r("open", ["&:is([open], :popover-open, :open)"]), r("default", ["&:default"]), r("checked", ["&:checked"]), r("indeterminate", ["&:indeterminate"]), r("placeholder-shown", ["&:placeholder-shown"]), r("autofill", ["&:autofill"]), r("optional", ["&:optional"]), r("required", ["&:required"]), r("valid", ["&:valid"]), r("invalid", ["&:invalid"]), r("in-range", ["&:in-range"]), r("out-of-range", ["&:out-of-range"]), r("read-only", ["&:read-only"]), r("empty", ["&:empty"]), r("focus-within", ["&:focus-within"]), t.static("hover", (e => {
					...
					"arbitrary" === t.value.kind ? e.nodes = [b(`&[aria-${We(t.value.value)}]`, e.nodes)] : e.nodes = [b(`&[aria-${t.value.value}="true"]`, e.nodes)]
				})), t.suggest("aria", (() => ["busy", "checked", "disabled", "expanded", "hidden", "pressed", "readonly", "required", "selected"])), t.functional("data", ((e, t) => {
					if (!t.value || t.modifier) return null;
					e.nodes = [b(`&[data-${We(t.value.value)}]`, e.nodes)]
				...
				}), r("motion-safe", ["@media (prefers-reduced-motion: no-preference)"]), r("motion-reduce", ["@media (prefers-reduced-motion: reduce)"]), r("contrast-more", ["@media (prefers-contrast: more)"]), r("contrast-less", ["@media (prefers-contrast: less)"]);
				{
					let r = function(e, t, r, n) {
						...
						let i = n.get(t);
						return null === i ? "asc" === r ? 1 : -1 : I(o, i, r)
					};
					{
			...
			i = new c((e => Array.from(function*(e, t) {
				let r = L(e, ":");
				if (t.theme.prefix) {
				...
				if (null === a || null !== u)
					if ("[" !== l[0]) {
						if ("]" === l[l.length - 1]) {
							...
							c = [
								[r, null === i ? `[var(${n})]` : `[${i}:var(${n})]`]
							]
						} else c = R(l, (e => t.utilities.has(e, "functional")));
						for (let [t, r] of c) {
							let n = {
								kind: "functional",
								root: t,
			...
			l = new c((e => {
				let t = function(e, t) {
					let r = function(e, t) {
						if ("arbitrary" === e.kind) {
							let r = e.value;
							return e.modifier && (r = $e(r, e.modifier, t.theme)), null === r ? [] : [
								[y(e.property, r)]
							]
						}
					...
					for (let o of r) {
						...
						for (let r of e.variants)
							if (null === Le(l, r, t.variants)) return [];
						n.push({
							node: l,
							propertySort: r
						})
			...
			s = {
				...
				getClassOrder(e) {
					return function(e, t) {
						let {
							astNodes: r,
							nodeSorting: n
						} = Be(Array.from(t), e), o = new Map(t.map((e => [e, null]))), i = 0n;
						for (let e of r) {
					...
					return function(e) {
						...
						for (let [r, n] of e.variants.entries()) {
							let o = function({
								...
								if (null === Le(a, l, e.variants)) return [];
								let s = [];
								return C(a.nodes, ((e, {
									path: t
								}) => {
				...
				resolveThemeValue(t, r = !0) {
					let n = t.lastIndexOf("/"),
						o = null; - 1 !== n && (o = t.slice(n + 1).trim(), t = t.slice(0, n).trim());
	...
	function Be(e, t, {
		...
		return o.sort(((e, t) => {
			...
			return (r.properties.order[i] ?? 1 / 0) - (o.properties.order[i] ?? 1 / 0) || o.properties.count - r.properties.count || Ke(r.candidate, o.candidate)
		})), {
			astNodes: o,
			nodeSorting: n
		}
	...
	function Le(e, t, r, n = 0) {
		...
		if ("compound" === t.kind) {
			let i = w("@slot");
			if (null === Le(i, t.variant, r, n + 1) || "not" === t.root && i.nodes.length > 1) return null;
	...
	function Re(e) {
		for (let t of e) "at-root" !== t.kind && ("declaration" === t.kind ? t.important = !0 : ("rule" === t.kind || "at-rule" === t.kind) && Re(t.nodes))
	}
		...
		for (; n.length > 0;) {
			...
			if ("declaration" === e.kind) {
				...
				if ("--tw-sort" === e.property) {
					let r = _e.indexOf(e.value ?? "");
					if (-1 !== r) {
						t.add(r), o = !0;
						continue
					}
				}
				let n = _e.indexOf(e.property); - 1 !== n && t.add(n)
				...
				if ("@utility" === e.name) {
					...
					return l.get(r).add(e), void z(e.nodes, (r => {
						if ("at-rule" === r.kind && "@apply" === r.name) {
							o.add(e);
							for (let n of Pe(r, t)) i.get(e).add(n)
						}
					}))
				}
				if ("@apply" === e.name) {
					if (null === n) return;
					r |= 1, o.add(n);
					for (let r of Pe(e, t)) i.get(n).add(r)
				}
			}
		}));
		let a = new Set,
			...
			if (!a.has(e)) {
				if (u.has(e)) {
					...
					throw "at-rule" === e.kind && "@utility" === e.name && "at-rule" === n.kind && "@utility" === n.name && z(e.nodes, (e => {
						...
						for (let e of r)
							for (let r of t.parseCandidate(e)) switch (r.kind) {
								case "arbitrary":
									break;
								case "static":
								case "functional":
				...
				for (let t of i.get(e))
					for (let n of l.get(t)) r.push(e), d(n, r), r.pop();
	...
	function* Pe(e, t) {
		for (let r of e.params.split(/\s+/g))
			for (let e of t.parseCandidate(r)) switch (e.kind) {
				case "arbitrary":
					break;
				case "static":
				case "functional":
		...
		return z(e, ((e, {
			...
			if ("at-rule" === e.kind && ("@import" === e.name || "@reference" === e.name)) {
				...
				return l.push((async () => {
					...
					let e = await n(c, r),
						i = t(e.content);
					await He(i, e.base, n, o + 1), h.nodes = function(e, t, r, n) {
						let o = e;
	...
	function Ze(e, {
			...
			function(e) {
				...
				return Je(e, [], ((e, r) => {
					...
					if (function(e) {
						...
						t.push([r, e[0]]);
						for (let n of Reflect.ownKeys(e[1])) t.push([
							[...r, `-${n}`], e[1][n]
						]);
						return 1
					}
		...
		if (Object.hasOwn(t, "fontFamily")) {
			let r = 5;
			{
				let n = Ye(t.fontFamily.sans);
				n && e.theme.hasDefault("--font-sans") && (e.theme.add("--default-font-family", n, r), e.theme.add("--default-font-feature-settings", Ye(t.fontFamily.sans, "fontFeatureSettings") ?? "normal", r), e.theme.add("--default-font-variation-settings", Ye(t.fontFamily.sans, "fontVariationSettings") ?? "normal", r))
			} {
				let n = Ye(t.fontFamily.mono);
				n && e.theme.hasDefault("--font-mono") && (e.theme.add("--default-mono-font-family", n, r), e.theme.add("--default-mono-font-feature-settings", Ye(t.fontFamily.mono, "fontFeatureSettings") ?? "normal", r), e.theme.add("--default-mono-font-variation-settings", Ye(t.fontFamily.mono, "fontVariationSettings") ?? "normal", r))
			}
		}
		return t
	}
	...
	function Je(e, t = [], r) {
		for (let n of Reflect.ownKeys(e)) {
			...
			if (1 !== l) {
				if (2 === l) return 2;
				if ((Array.isArray(o) || "object" == typeof o) && 2 === Je(o, i, r)) return 2
			}
		}
	}
		...
		for (let o of t)
			if (null != o)
				for (let t of Reflect.ownKeys(o)) {
					n.push(t);
					let i = r(e[t], o[t], n);
					void 0 !== i ? e[t] = i : et(e[t]) && et(o[t]) ? e[t] = tt({}, [e[t], o[t]], r, n) : e[t] = o[t], n.pop()
				}
		return e
	}
	...
	function rt(e, t, r) {
		return function(n, o) {
			let l = n.lastIndexOf("/"),
				a = null; - 1 !== l && (a = n.slice(l + 1).trim(), n = n.slice(0, l).trim());
			let s = (() => {
				let o = Qe(n),
					[l, a] = function(e, t) {
						...
						for (let [e, t] of l) ot(u, [e ?? "DEFAULT"], t);
				...
				if (null !== s && "object" == typeof s && !Array.isArray(s)) {
					...
					for (let t in l) "__CSS_VALUES__" !== t && (4 & s?.__CSS_VALUES__?.[t] && void 0 !== nt(e, t.split("-")) || (e[i(t)] = l[t]));
					return e
				}
			...
			return a && "string" == typeof s && (s = xe(s, a)), s ?? o
		}
	}
		...
		for (let n = 0; n < e.length; n++) {
			let o = e[n],
				...
				a = t(o, {
					parent: r,
					replaceWith(t) {
						i || (i = !0, Array.isArray(t) ? 0 === t.length ? (e.splice(n, 1), l = 0) : 1 === t.length ? (e[n] = t[0], l = 1) : (e.splice(n, 1, ...t), l = t.length) : (e[n] = t, l = 1))
					}
				}) ?? 0;
			if (i) 0 === a ? n-- : n += l - 1;
			else {
				if (2 === a) return 2;
				if (1 !== a && "function" === o.kind && 2 === ut(o.nodes, t, o)) return 2
			}
		}
	}
	...
	function ft(e) {
			...
			switch (a) {
				...
				case 40: {
					...
					if (i = "", ":not" !== a.value && ":where" !== a.value && ":has" !== a.value && ":is" !== a.value) {
						...
						let c = l;
						a.nodes.push(ct(e.slice(n, c))), i = "", l = c, o ? o.nodes.push(a) : r.push(a);
						break
					}
		...
		return i.length > 0 && r.push(at(i)), r
	}
	var ht = /^[a-z@][a-zA-Z0-9/%._-]*$/;
	...
	function pt({
		...
		let i = {
			addBase(r) {
				if (o) return;
				let i = mt(r);
				n.current |= je(i, e), t.push(w("@layer", "base", i))
			},
			addVariant(t, r) {
				if (!Ne.test(t)) throw new Error(`\`addVariant('${t}')\` defines an invalid variant name. Variants should only contain alphanumeric, dashes or underscore characters.`);
				"string" == typeof r || Array.isArray(r) ? e.variants.static(t, (e => {
					e.nodes = gt(r, e.nodes)
				}), {
					compounds: Fe("string" == typeof r ? [r] : r)
				}) : "object" == typeof r && e.variants.fromAst(t, mt(r))
			},
			matchVariant(t, r, n) {
				function o(e, t, n) {
					return gt(r(e, {
			...
			addUtilities(r) {
				...
				for (let [e, r] of i) {
					...
					let n = ft(e),
						i = !1;
					if (ut(n, (e => {
							if ("selector" === e.kind && "." === e.value[0] && ht.test(e.value.slice(1))) {
								let t = e.value;
								e.value = "&";
								let o = dt(n),
									a = t.slice(1),
				...
				for (let [t, r] of l) e.theme.prefix && z(r, (t => {
					...
					return vt(i, t, o.raw), n.current |= qe(i, e), i
				}))
			},
			matchUtilities(t, r) {
				...
				for (let [i, l] of Object.entries(t)) {
					let t = function({
						...
						return a => {
							if ("arbitrary" === a.value?.kind && o.length > 0 && !o.includes("any") && (a.value.dataType && !o.includes(a.value.dataType) || !a.value.dataType && !Y(a.value.value, o))) return;
							let s, c = o.includes("color"),
								u = null,
								d = !1;
							{
								let e = r?.values ?? {};
							...
							c && null !== s && (u = xe(u, s)), t && (u = `calc(${u} * -1)`);
							let f = mt(l(u, {
								modifier: s
							}));
							return vt(f, i, a.raw), n.current |= qe(f, e), f
						}
					};
					if (!ht.test(i)) throw new Error(`\`matchUtilities({ '${i}' : … })\` defines an invalid utility name. Utilities should be alphanumeric and start with a lowercase letter, eg. \`scrollbar\`.`);
	...
	function mt(e) {
		...
		for (let [e, n] of r)
			...
			for (let r of n) "string" == typeof r ? t.push(y(e, r)) : t.push(k(e, mt(r)));
		else null !== n && t.push(k(e, mt(n)));
		return t
	}
	...
	function bt(e, t, r) {
		for (let r of function(e) {
				...
				if ("keyframes" in e.theme)
					for (let [r, n] of Object.entries(e.theme.keyframes)) t.push(w("@keyframes", r, mt(n)));
				return t
	...
	function Et(e, t) {
		let r = {
			...
			theme: {},
			extend: {},
			result: structuredClone(Kt)
		};
		for (let e of t) Nt(r, e);
	...
	function Vt(e, t) {
		return Array.isArray(e) && et(e[0]) ? e.concat(t) : Array.isArray(t) && et(t[0]) && et(e) ? [e, ...t] : Array.isArray(t) ? t : void 0
	}
	...
	function Nt(e, {
		...
		for (let i of t.presets ?? []) Nt(e, {
			path: n,
			base: r,
			config: i,
			reference: o
		});
		for (let t of i) e.plugins.push(t), t.config && Nt(e, {
			path: n,
			base: r,
			config: t.config,
		...
		let l = t.content ?? [],
			a = Array.isArray(l) ? l : l.files;
		for (let t of a) e.content.files.push("object" == typeof t ? t : {
			base: r,
			pattern: t
		});
		e.configs.push(t)
	...
	function Ot(e, t) {
		...
		let n = function({
			...
			if (e && o.push(y("margin-inline", "auto")), ("string" == typeof t || "object" == typeof t && null !== t && "DEFAULT" in t) && o.push(y("padding-inline", "string" == typeof t ? t : t.DEFAULT)), "object" == typeof r && null !== r) {
				...
				if (e.sort(((e, t) => I(e[1], t[1], "asc"))), e.length > 0) {
					let [t] = e[0];
			...
			if ("object" == typeof t && null !== t) {
				...
				e.sort(((e, t) => I(e[1], t[1], "asc")));
				for (let [t, , r] of e)
					if (i && i.has(t)) i.get(t).nodes.push(y("padding-inline", r));
					else {
						if (i) continue;
		...
		z(r, ((e, {
			...
			function(e) {
				for (let [t, r] of [
						...
						["l", "left"],
						["tl", "top left"]
					]) e.utilities.static(`bg-gradient-to-${t}`, (() => [y("--tw-gradient-position", `to ${r} in oklab`), y("background-image", "linear-gradient(var(--tw-gradient-stops))")]));
				e.utilities.functional("max-w-screen", (t => {
					...
					if (!e.modifier) {
						...
						if (ce(e.value.value)) return [y("flex-shrink", e.value.value)]
					}
					...
					if (!e.modifier) {
						...
						if (ce(e.value.value)) return [y("flex-grow", e.value.value)]
					}
				}))
			}(e);
		let s = e.resolveThemeValue;
		if (e.resolveThemeValue = function(n, l) {
				return n.startsWith("--") ? s(n, l) : (i |= _t({
					designSystem: e,
					base: t,
					ast: r,
					globs: o,
					configs: [],
					pluginDetails: []
				}), e.resolveThemeValue(n, l))
			}, !l.length && !a.length) return 0;
		let [c, u] = await Promise.all([Promise.all(a.map((async ({
			id: e,
			base: t,
			reference: r
		}) => {
	...
	function _t({
		...
		if (Ze(e, c, u), bt(e, c), function(e, t) {
				let r = e.theme.aria || {},
					n = e.theme.supports || {},
					o = e.theme.data || {};
				...
				for (let [e, i] of Object.entries(r)) {
					let r = function(r) {
						...
						l = t.variants.get(e),
						a = t.theme.resolveValue(e, ["--breakpoint"]);
			...
			}(c, e), Ot(c, e), !e.theme.prefix && s.prefix) {
			if (s.prefix.endsWith("-") && (s.prefix = s.prefix.slice(0, -1), console.warn(`The prefix "${s.prefix}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only and is written as a variant before all utilities. We have fixed up the prefix for you. Remove the trailing \`-\` to silence this warning.`)), !Ut.test(s.prefix)) throw new Error(`The prefix "${s.prefix}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);
	...
	async function Rt(e, {
		...
		z(e, ((e, {
			...
			if ("at-rule" === e.kind) {
					...
					let r = function(e) {
						...
						return be.test(t) ? r => {
							...
							z(e.nodes, (e => {
									...
									if (!("--spacing" !== e.value || n["--modifier"].usedSpacingNumber && n["--value"].usedSpacingNumber)) return h(e.nodes, (e => {
										...
										for (let r of e.nodes)
											if ("word" === r.kind)
												...
												else if ("number" === r.value && (n[t].usedSpacingNumber ||= !0, n["--modifier"].usedSpacingNumber && n["--value"].usedSpacingNumber)) return 2
									})), 0;
								...
								if (d)
									for (let [e, t] of u) {
										let r = t.nodes.indexOf(e); - 1 !== r && t.nodes.splice(r, 1)
									}
								return n.nodes
				...
				if ("@variant" === e.name && (null === t ? 0 === e.nodes.length ? e.name = "@custom-variant" : (z(e.nodes, (t => {
					...
					r([]);
					let [n, o] = L(e.params, " ");
					if (!Ne.test(n)) throw new Error(`\`@custom-variant ${n}\` defines an invalid variant name. Variants should only contain alphanumeric, dashes or underscore characters.`);
				...
				if ("@media" === e.name) {
					...
					for (let r of t)
						if (r.startsWith("source(")) {
							...
							z(e.nodes, ((e, {
								...
								if ("at-rule" === e.kind && "@tailwind" === e.name && "utilities" === e.params) return e.params += ` source(${t})`, r([$({
									sourceBase: n.base
								}, [e])]), 2
							}))
					...
					} else "important" === r ? a = !0 : "reference" === r ? e.nodes = [$({
						reference: !0
					}, e.nodes)] : o.push(r);
				...
				if ("@theme" === e.name) {
					...
					if (n.reference && (t |= 2), o) {
						if (!Bt.test(o)) throw new Error(`The prefix "${o}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);
						c.prefix = o
					}
					return z(e.nodes, (r => {
		...
		let K = De(c);
		if (a && (K.important = a), T.length > 0)
			for (let e of T) K.invalidCandidates.add(e);
		l |= await Dt({
			designSystem: K,
			base: t,
			ast: e,
		...
		if (f) {
			let t = [];
			for (let [e, r] of K.theme.entries()) 2 & r.options || t.push(y(o(e), r.value));
		...
		if (v.length > 0) {
			for (let e of v) {
				...
				if (null === Le(t, n, K.variants)) throw new Error(`Cannot use \`@variant\` with variant: ${r}`);
				Object.assign(e, t)
			}
			l |= 32
		}
		return l |= je(e, K), l |= qe(e, K), z(e, ((e, {
			replaceWith: t
		}) => {
	...
	async function It(e, r = {}) {
		let n = t(e),
			o = await async function(e, t = {}) {
				...
				n.unshift(x("! tailwindcss v4.0.17 | MIT License | https://tailwindcss.com "));
				let u = new Set,
					d = null,
					f = 0,
					h = !1;
						...
						for (let e of t)
							if (!r.invalidCandidates.has(e))
								if ("-" === e[0] && "-" === e[1]) {
									...
									o ||= t, i ||= t
								} else u.add(e), o ||= u.size !== s;
						if (!o) return d ??= T(n, r), d;
						let p = Be(u, r, {
							onInvalidCandidate: c
						}).astNodes;
						return i || f !== p.length ? (f = p.length, l.nodes = p, d = T(n, r), d) : (d ??= T(n, r), d)
					}
				}
			}(n, r), i = n, l = e;
		return {
	...
	async function er(e, t) {
		try {
			...
			return Qt.hit("Loaded stylesheet", {
				id: e,
				base: t,
				size: r.content.length
			}), r
		} catch (r) {
			throw Qt.hit("Failed to load stylesheet", {
				id: e,
				base: t,
				error: r.message ?? r
			}), r
	...
	function rr(e) {
		Xt = Xt.then((async function() {
			if (!Pt && "full" !== e) return;
			let t = Jt++;
			Qt.start(`Build #${t} (${e})`), "full" === e && await async function() {
				Qt.start("Create compiler"), Qt.start("Reading Stylesheets");
				let e = document.querySelectorAll(`style[type="${Ht}"]`),
					t = "";
				for (let r of e) or(r), t += r.textContent + "\n";
				if (t.includes("@import") || (t = `@import "tailwindcss";${t}`), Qt.end("Reading Stylesheets", {
						size: t.length,
						changed: Zt !== t
					}), Zt !== t) {
					Zt = t, Qt.start("Compile CSS");
					try {
						Pt = await It(t, {
							base: "/",
							loadStylesheet: er,
						...
						Qt.end("Compile CSS"), Qt.end("Create compiler")
					}
					Yt.clear()
				}
			}(), Qt.start("Build"), await async function(e) {
				if (!Pt) return;
				let t = new Set;
				Qt.start("Collect classes");
				for (let e of document.querySelectorAll("[class]"))
					for (let r of e.classList) Yt.has(r) || (Yt.add(r), t.add(r));
				Qt.end("Collect classes", {
					count: t.size
				}), (0 !== t.size || "incremental" !== e) && (Qt.start("Build utilities"), Gt.textContent = Pt.build(Array.from(t)), Qt.end("Build utilities"))
			}(e), Qt.end("Build"), Qt.end(`Build #${t} (${e})`)
		})).catch((e => Qt.error(e)))
	}
	var nr = new MutationObserver((() => rr("full")));
	...
	new MutationObserver((e => {
		let t = 0,
			r = 0;
		for (let n of e) {
			for (let e of n.addedNodes) e.nodeType === Node.ELEMENT_NODE && "STYLE" === e.tagName && e.getAttribute("type") === Ht && (or(e), t++);
			for (let e of n.addedNodes) 1 === e.nodeType && e !== Gt && r++;
			"attributes" === n.type && r++
		}
		return t > 0 ? rr("full") : r > 0 ? rr("incremental") : void 0
	})).observe(document.documentElement, {
		attributes: !0,
		attributeFilter: ["class"],
		childList: !0,
		subtree: !0
	}), rr("full"), document.head.append(Gt)
})();
